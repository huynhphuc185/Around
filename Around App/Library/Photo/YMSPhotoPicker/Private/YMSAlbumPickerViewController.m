...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *cancelItem =  [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"close x2"] style:UIBarButtonItemStyleDone target:self action:@selector(dismiss:)];
