...
@interface BaseChatViewController : UIViewController <UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, readonly, strong) UICollectionView * _Null_unspecified collectionView;
- (void)loadView;
- (void)viewDidLoad;
@property (nonatomic) BOOL endsEditingWhenTappingOnChatBackground;
- (void)userDidTapOnCollectionView;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
- (void)setupKeyboardTracker;
@property (nonatomic, readonly) BOOL isFirstLayout;
- (void)viewDidLayoutSubviews;
@property (nonatomic, readonly, strong) UIView * _Null_unspecified inputContainer;
- (UICollectionViewLayout * _Nonnull)createCollectionViewLayout SWIFT_WARN_UNUSED_RESULT;
- (UIView * _Nonnull)createChatInputView SWIFT_WARN_UNUSED_RESULT;
...
@interface BaseChatViewController (SWIFT_EXTENSION(Chatto))
@property (nonatomic) BOOL accessoryViewRevealerIsEnabled;
@end

@class UIScrollView;

@interface BaseChatViewController (SWIFT_EXTENSION(Chatto))
- (BOOL)isScrolledAtBottom SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isScrolledAtTop SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isCloseToBottom SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isCloseToTop SWIFT_WARN_UNUSED_RESULT;
- (CGRect)visibleRect SWIFT_WARN_UNUSED_RESULT;
